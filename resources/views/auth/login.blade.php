...
@section('main')
<div class="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md" data-aos="fade-up" data-aos-duration="1000">
    <div class="flex items-center justify-center gap-2 mx-auto font-bold">
        <img class="w-auto h-7 sm:h-8" src="{{ asset('logo/exponent-dark.png') }}" alt="Exponent Team Logo">
        Login
    </div>
    <form class="mt-6">
        <div>
            <label for="username" class="block text-sm text-gray-800">Username</label>
            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
        </div>
        ...
        <div class="mt-4">
            ...
            <input type="password" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
        </div>
