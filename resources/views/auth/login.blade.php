...
@section('main')
<div class="flex w-full max-w-sm p-6 md:p-0 md:max-w-2xl m-auto backdrop-blur-3xl shadow-md gap-4 bg-white/50"
    data-aos="fade-up" data-aos-duration="1000">
    <div class="hidden md:block">
        <img src="{{ asset('hero/images/background_form.jpg') }}" class="w-60 h-full object-cover" alt="bg">
    </div>
    <div class=" w-full max-w-sm md:p-4">
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <a href="#"
                class="font-medium text-gray-700 hover:underline">Create One</a></p>
    </div>
</div>
@endsection