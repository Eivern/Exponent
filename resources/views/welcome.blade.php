...
@section('main')
{{-- Hero --}}
<div class="container px-6 py-16 mx-auto text-center mt-20" style="height: 70dvh;" data-aos="fade-up" data-aos-duration="1000" id="home">
    <div class="max-w-lg mx-auto">
        <h1 class="text-3xl font-semibold text-gray-800 lg:text-4xl">Create Extraordinary Solutions with {{ config('app.name') }}.</h1>

        <p class="mt-6 text-gray-500">
          At Exponent Team, we create cutting-edge websites, offer top-tier coding courses, provide expert consultations, and host dynamic monthly code events. Join us in building the future of technology.
        </p>

        <div class="flex justify-center mt-10">
          <a class="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 focus:outline-none focus:border-gray-300" href="{{ config('app.discord_url') }}" target="_blank">
    ...
    <div class="max-w-screen-xl mx-auto mt-20">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
            <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1" data-aos-delay="1000" data-aos="fade-right">
            ...
            <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1" data-aos-delay="1000" data-aos="fade-up">
              <div class="hs-tooltip inline-block">
            ...
            <div class="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1" data-aos-delay="1000" data-aos="fade-left">
              <div class="hs-tooltip inline-block">
            ...
            <div class="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1" data-aos-delay="1000" data-aos="fade-left">
              <div class="hs-tooltip inline-block">
...
{{-- About --}}
<section>
    <div class="container px-6 pb-10 pt-24 mx-auto h-fit mb-16">
        ...
        {{-- Course Modal --}}
        <div id="service-course-modal" class="hs-overlay hs-overlay-backdrop-open:backdrop-blur-sm hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-custom-backdrop-label">
          <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
            <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
              <div class="flex justify-between items-center py-3 px-4 border-b">
                ...
                <button type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none" aria-label="Close" data-hs-overlay="#service-course-modal">
                ...
                <div>
                  ...
                  <div class="flex gap-x-3">
                    ...
                    <div class="grow pt-0.5 pb-8">
                      ...
                      <p class="mt-1 text-sm text-gray-600">
                        Dive into the world of Python, one of the most versatile and powerful programming languages today. Whether you're just starting your coding journey or looking to deepen your knowledge, this course will guide you through the essentials to advanced concepts of Python programming.
                      </p>
                    </div>
                    <!-- End Right Content -->
                  </div>
                  ...
                  <div class="px-4 py-2 -mx-3">
                      <div class="mx-3">
                          ...
                          <p class="text-sm text-gray-600">
                            Our courses are available in both public and private (or one-on-one) formats, with flexible pricing to suit your learning preferences and needs.
                          </p>
                      </div>
                  </div>
                </div>
              ...
              <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t">
                <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#service-course-modal">
                  Close
                </button>
        ...
        {{-- Web dev Modal --}}
        <div id="web-dev-modal" class="hs-overlay hs-overlay-backdrop-open:backdrop-blur-sm hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-custom-backdrop-label">
          <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
            <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
              <div class="flex justify-between items-center py-3 px-4 border-b">
                <h3 id="hs-custom-backdrop-label" class="font-bold text-gray-800">
                ...
                <button type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none" aria-label="Close" data-hs-overlay="#web-dev-modal">
                  <span class="sr-only">Close</span>
                  <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M18 6 6 18"></path>
                    <path d="m6 6 12 12"></path>
              ...
              <div class="p-4 overflow-y-auto">
                ...
                <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                  ...
                  <div class="mx-auto text-center mb-6">
                    <h2 class="text-xl font-semibold md:text-2xl md:leading-tight text-gray-800">Technologies we used in developments</h2>
                  </div>
                  <!-- End Title -->
                  ...
                  <div class="flex w-full max-w-fit mt-10 overflow-hidden bg-white rounded-lg shadow-md">
                    ...
                    <div class="px-4 py-2 -mx-3">
                        <div class="mx-3">
                            <span class="font-semibold text-neutral-800">Info</span>
                            <p class="text-sm text-gray-600">
                              We provide a range of web development solutions, from affordable, SEO-friendly, and responsive websites to sophisticated, fully customized platforms, all tailored to fit your budget and unique needs.
                            </p>
                        </div>
                    </div>
                  </div>
              ...
              <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t">
                <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#web-dev-modal">
                  Close
                </button>
                <a href="" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                  More Information &rightarrow;
        ...
        {{-- Consultation Modal --}}
        <div id="consultation-modal" class="hs-overlay hs-overlay-backdrop-open:backdrop-blur-sm hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-custom-backdrop-label">
          <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
            <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
              <div class="flex justify-between items-center py-3 px-4 border-b">
                <h3 id="hs-custom-backdrop-label" class="font-bold text-gray-800">
                ...
                <button type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none" aria-label="Close" data-hs-overlay="#consultation-modal">
                  <span class="sr-only">Close</span>
                  <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M18 6 6 18"></path>
                    <path d="m6 6 12 12"></path>
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl p-4 space-y-3">
                      ...
                      <div class="space-y-1.5">
                        <p class="mb-1.5 text-sm text-gray-800">
                          Expert Guidance to Transform Ideas into Robust, Scalable, and High-Performance Solutions.
                          We can help you to ;
                        </p>
                  ...
                  <li class="max-w-lg flex gap-x-2 sm:gap-x-4">
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl p-4 space-y-3">
                      ...
                      <div class="space-y-1.5">
                        ...
                        <ul>
                          <li>
                            <a data-hs-overlay="#consultation-modal" class="text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#contact">
                              Contact us
                            </a>
                          </li>
                          <li>
                            <a class="text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" target="_blank" href="{{ config('app.discord_url') }}">
                              Join the community
                            </a>
                          </li>
                        </ul>
              ...
              <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t">
                <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#consultation-modal">
                  Close
                </button>
              </div>
            </div>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            <div class="space-y-3" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p class="text-gray-500 text-justify">
                  Master the skills of tomorrow with our coding courses. From beginner to advanced levels, our hands-on training covers popular programming languages, frameworks, and best practices to help you excel in the tech industry.
                </p>

                <button aria-haspopup="dialog" aria-expanded="false" aria-controls="service-course-modal" data-hs-overlay="#service-course-modal" class="inline-flex items-center -mx-1 text-sm text-blue-500 capitalize transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
            ...
            <div class="space-y-3" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p class="text-gray-500 text-justify">
                  Bring your vision to life with our tailor-made web solutions. Whether it's a sleek portfolio, an e-commerce platform, or a complex web application, Exponent Team delivers responsive, secure, and scalable websites that set you apart.
                </p>

                <button aria-haspopup="dialog" aria-expanded="false" aria-controls="web-dev-modal" data-hs-overlay="#web-dev-modal" class="inline-flex items-center -mx-1 text-sm text-blue-500 capitalize transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
                    <span class="mx-1">read more</span>
                    <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
            </div>
            ...
            <div class="space-y-3" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p class="text-gray-500 text-justify">
                  Navigate your tech challenges with confidence. Our consultation services provide you with the strategic insights and technical expertise needed to overcome obstacles, streamline processes, and achieve your business goals.
                </p>

                <button aria-haspopup="dialog" aria-expanded="false" aria-controls="consultation-modal" data-hs-overlay="#consultation-modal" class="inline-flex items-center -mx-1 text-sm text-blue-500 capitalize transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
                    <span class="mx-1">read more</span>
                    <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
            </div>
            ...
            <div class="space-y-3" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p class="text-gray-500 text-justify">
                  Join the Sopwer Enjiner Code Competition, where developers create innovative projects or showcase their skills in a friendly, competitive environment. A new challenge awaits you every month!
                </p>
            </div>
            ...
            <div class="space-y-3" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p class="text-gray-500 text-justify">
                  Participate in the Sopwer Enjiner Weekly Code, a series of bite-sized coding challenges designed to push your limits. Submit your solutions on our Discord server and compete with peers.
                </p>
            </div>
            ...
            <div class="space-y-3" data-aos="fade-up" data-aos-duration="1000">
                ...
                <h1 class="text-xl font-semibold text-gray-700 capitalize">Connect, Collaborate, and Code with Sopwer Enjiner</h1>

                <p class="text-gray-500 text-justify">
                  Join our vibrant Discord community, where developers from all levels gather to share knowledge, solve problems, and grow together. Whether you’re a newbie or a pro, there’s a place for you here.
                </p>

                <a href="{{ config('app.discord_url') }}" target="_blank" class="inline-flex items-center -mx-1 text-sm text-blue-500 capitalize transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
...
<div class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
  <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14" data-aos="fade-right" data-aos-duration="1000">
              <h2 class="text-2xl font-semibold md:text-4xl md:leading-tight">You might be wondering...</h2>
            ...
            <div class="max-w-2xl mx-auto">
              ...
              <div class="hs-accordion-group">
                ...
                <div class="hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6" id="hs-basic-with-title-and-arrow-stretched-heading-six">
    ...
    <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
      <img data-aos="fade-left" data-aos-duration="1000" class="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" src="{{ asset('hero/images/community.png') }}" alt="Community Hero Image">
    </div>
  </div>
</div>
{{-- End of FAQ --}}
